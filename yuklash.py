...
# 650 580 670
URL = 'https://jonibekodoo-trot-2-test-33172300.dev.odoo.com/odoo/action-775/119884'
LOGIN = 'admin'
PASSWORD = '123456'
    ...
    async with async_playwright() as p:
        ...
        while True:
            ...
            for idx in range(len(op_cells)):
                ...
                inp = page.locator('td[name="operation_id"].o_currently_editing input, .o_selected_row td[name="operation_id"] input').first
                try:
                    await inp.clear()
                    await inp.fill('Ishlab chiqarish')
                    await asyncio.sleep(0.4)
                    option = page.locator('.o-autocomplete--dropdown-menu a, .ui-autocomplete li a').first
